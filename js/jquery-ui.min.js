...
/*add by wangxin 2016-4-2 ui.box.show() 浮层方法*/
var ui={changeDepartment:function(c,a,b,e,d){this.box.load(U("widget/Department/change","",0)+"&hid="+c+"&showName="+a+"&sid="+b+"&nosid="+e+"&notop="+d,L("PUBLIC_DEPATEMENT_SELECT"))},showMessage:function(k,g,d){var a=(g=="1")?"html_clew_box clew_error ":"html_clew_box";var f=(g=="1")?"ico-question-sign":"ico-ok-sign";var e='<div class="'+a+'" id="ui_messageBox" style="display:none"><div class="html_clew_box_con" id="ui_messageContent"><i class="'+f+'"></i>'+k+"</div></div>";var j=function(){for(var l=0;l<arguments.length;l++){if(typeof arguments[l]!="undefined"){return false}}return true};$(e).appendTo(document.body);var c=$("#ui_messageBox").height();var i=$("#ui_messageBox").width();var b=($("body").width()-i)/2;var h=$(window).scrollTop()+($(window).height()-c)/2;$("#ui_messageBox").css({left:b+"px",top:h+"px"}).fadeIn("slow",function(){$("#ui_messageBox")});setTimeout(function(){$("#ui_messageBox").find("iframe").remove();$("#ui_messageBox").fadeOut(function(){$("#ui_messageBox").remove()})},d*1000)},showblackout:function(){if($(".boxy-modal-blackout").length>0){}else{var a=$("body").height()>$(document).height()?$("body").height():$(document).height();$('<div class ="boxy-modal-blackout" style=""></div>').css({height:a+"px",width:$("body").width()+"px",zIndex:10010}).appendTo(document.body)}},removeblackout:function(){if($("#uibox").length>0){if(document.getElementById("uibox").style.display=="none"){$(".boxy-modal-blackout").remove()}}else{$(".boxy-modal-blackout").remove()}},success:function(b,c){var a="undefined"==typeof(c)?1:c;ui.showMessage(b,0,a)},error:function(b,c){var a="undefined"==typeof(c)?1.5:c;ui.showMessage(b,1,a)},confirm:function(o,text,_callback,button){if(typeof button=="undefined"){button={yes:"确认",no:"取消"}}if($("#ui_box_confirm").length>0){$("#ui_box_confirm").remove()}var callback="undefined"==typeof(_callback)?$(o).attr("callback"):_callback;text=text||L("PUBLIC_ACCONT_TIPES");text="<i class='ico-question-sign'></i>"+text;this.html='<div id="ui_box_confirm" class="ui_confirm"><div class="layer-mini-info"><dl><dt class="txt"> </dt><dd class="action"><a class="btn btn-blue-mini mr10" href="javascript:void(0)"><span>'+button.yes+'</span></a><a class="btn btn-mini" href="javascript:void(0)"><span>'+button.no+"</span></a></dd></dl></div></div>";$("body").append(this.html);var position=$(o).offset();if(document.documentElement.clientWidth<(position.left+$("#ui_box_confirm").width())){var left=position.left-$("#ui_box_confirm").width()}else{var left=(position.left-$("#ui_box_confirm").width()+8+$(o).width()/2)}if($(document).height()<(position.top+$("#ui_box_confirm").height())){var top=position.top-$("#ui_box_confirm").height()}else{var top=position.top}$("#ui_box_confirm").css({top:top+"px",left:left+"px",display:"none"});$("#ui_box_confirm .txt").html(text);$("#ui_box_confirm").fadeIn("fast");$("#ui_box_confirm .btn-mini").one("click",function(){$("#ui_box_confirm").fadeOut("fast");$("#ui_box_confirm").remove();return false});$("#ui_box_confirm .btn-blue-mini").one("click",function(){$("#ui_box_confirm").fadeOut("fast");$("#ui_box_confirm").remove();if("undefined"==typeof(callback)){return true}else{if("function"==typeof(callback)){callback()}else{eval(callback)}}});return false},confirmBox:function(title,text,callback,button,cancle_callback){if(typeof button=="undefined"){button={yes:"纭畾",no:"鍙栨秷"}}this.box.init(title);text=text||L("PUBLIC_ACCONT_TIPES");text="<i class='ico-question-sign'></i>"+text;var content='<div class="pop-create-group"><dl><dt class="txt">'+text+'</dt><dd class="action"><a class="btn btn-blue mr10" href="javascript:void(0)"><span>'+button.yes+'</span></a><a class="btn btn-gray" href="javascript:void(0)"><span>'+button.no+"</span></a></dd></dl></div>";this.box.setcontent(content);this.box.center();var _this=this;$("#uibox .btn-gray").one("click",function(){$("#uibox").fadeOut("fast",function(){$("#uibox").addClass("hideSweetAlert").remove()});_this.box.close();if("undefined"==typeof(cancle_callback)){return true}else{if("function"==typeof(cancle_callback)){cancle_callback()}else{eval(cancle_callback)}}return false});$("#uibox .btn-blue").one("click",function(){$("#uibox").fadeOut("fast",function(){$("#uibox").addClass("hideSweetAlert").remove()});_this.box.close();if("undefined"==typeof(callback)){return true}else{if("function"==typeof(callback)){callback()}else{eval(callback)}}});return false},box:{WRAPPER:'<table class="M-layer div-focus showSweetAlert" id="uibox" cellspacing="0" cellpadding="0" style="display:none"><tbody><tr><td><div class="M-content"><div class="bd" id="layer-content"></div></div></td></tr></tbody></table>',simple_box:'<table class="M-layer div-focus showSweetAlert" id="uibox" cellspacing="0" cellpadding="0" style="display:none;"><tbody><tr><td id="layer-content"></td></tr></tbody></table>',inited:false,IE6:"undefined"==typeof(document.body.style.maxHeight),init:function(d,e,c){this.callback=e;if($("#uibox").length>0){return false}else{if("undefined"==typeof(d)||d==""){$("body").prepend(this.simple_box)}else{$("body").prepend(this.WRAPPER)}}if("undefined"!=typeof(d)||d==""){$("<div class='hd'><a class='icon-close' href='javascript:;'></a><div class='M-title'>"+d+"</div></div>").insertBefore($("#uibox .bd"));$(".hd").mousedown(function(){$(".mod-at-wrap").remove()});$("#uibox").find(".icon-close").click(function(){ui.box.close(e);return false})}ui.showblackout();$("#uibox").stop().css({width:"",height:"","z-index":999999});var b=/opera/.test(navigator.userAgent.toLowerCase())?"keypress":"keydown";$(document.body).bind(b+".uibox",function(g){var f=g.keyCode?g.keyCode:g.which?g.which:g.charCode;if(f==27){$(document.body).unbind(b+".uibox");ui.box.close(e);return false}});this.center();if("undefined"==typeof(c)){var a=function(){$("#uibox").show()};setTimeout(a,200)}},setcontent:function(a){$("#layer-content").html(a)},close:function(fn){$("#uibox").addClass("hideSweetAlert").remove();$(".mod-at-wrap").remove();$("#recipientsTips").hide();jQuery(".boxy-modal-blackout").remove();if($("#rcalendar").length>0){$("#rcalendar").hide()}var back="";if("undefined"!=typeof(fn)){back=fn}else{if("undefined"!=typeof(this.callback)){back=this.callback}}if("function"==typeof(back)){back()}else{eval(back)}},alert:function(a,b,c){this.init(b,c);this.setcontent('<div class="question">'+a+"</div>");this.center()},show:function(a,b,c){this.init(b,c);this.setcontent(a);this.center()},showImage:function(f,e){this.init();if("undefined"==typeof(e)||e==""||e.indexOf("http")<0){e=f}var c=e.split("|");if(c.length>1){e=c[0];var b=c[1];var a=c[2]}else{var b=0;var a=0}var g=this;var d=function(n,l,h){var i=function(){var p={width:0,height:0};var o=screen.width;var r=screen.height;var q=Math.min((o*0.8)/l,(r*0.8)/h);if(q>=1){p.width=l;p.height=h}else{p.width=parseInt(l*q);p.height=parseInt(h*q)}return p};var k=function(q){if(q.width==0||q.height==0){var p=""}else{var p='width="'+q.width+'" height="'+q.height+'"'}var o=n.replace(/.jpg/,"_self.jpg");content='<div class="layer-close"><a class="icon-close" href="javascript:;"></a></div><div class="pop-show-img"><dl><dd><img src="'+n+'" '+p+'/></dd><dd class="img-info"><a href="'+o+'" target="_blank" class="qg-link">'+L("PUBLIC_LOOK_SOURCE")+"</a></dd></dl></div>";g.setcontent(content);g.center();$("#uibox").find(".icon-close").click(function(){ui.box.close();return false})};if(l==0||h==0){g.setcontent("<img src='"+THEME_URL+"/image/load.gif' >");g.center();var m=new Image();m.onload=function(){l=m.width;h=m.height;var o=i();k(o)};m.src=n}else{var j=i();k(j)}};d(e,b,a)},showDoc:function(a){if(a.is_img=="1"){this.showImage(a.img_src,a.img_alt_src);return false}this.init();content='<div class="pop-file-img"><div class="layer-close" ><a class="icon-close" href="javascript:;"></a></div><div><dl><dd class="center">'+a.html+'</a><a class="qg-link-bg"></a></dd><dd class="file-img-info"><a href="'+a.url+'" class="right" >'+a.tips+"</a>"+a.name+" <span>("+a.size+")</span></dd></dl></div></div>";this.setcontent(content);this.center();$("#uibox").find(".icon-close").click(function(){ui.box.close();return false})},removeReader:function(){$(".reader-box-container").fadeOut();$("#topcontrol").show();$("#autoTalkBox").show();$("#page-wrap").show()},showReader:function(d){if($(".reader-box-container").length>0){$("#topcontrol").hide();$("#autoTalkBox").hide();$("#page-wrap").hide();$(".reader-box-container").fadeIn();return false}var c=$(window).width();var a=$(window).height();var b='<div class="reader-box-container" style="width:'+c+"px;width:100%;height:"+a+'px;top:0;left:0;display:none;overflow-y:auto;"><div class="reader-box"><div class="reader-box-body"><div class="reader-pop"><div class="reader-close"><a href="javascript:;" class="icon-close" onclick="ui.box.removeReader()"></a></div><dl><dt class="reader-font-zoom"><span class="font-samll" >A</span><i class="vline">|</i><span class="font-big">A</span></dt><dd id="readBox" size="16" style="font-size:16px;">'+d+"</dd></dl></div></div></div></div>";$("body").append(b);if($("body").height()<$(window).height()+50){$(".reader-pop").css("height",$(window).height()-102+"px")}else{$(".reader-pop").css("min-height",$(window).height()-102+"px");$(".reader-pop").css("height","auto")}$("#topcontrol").hide();$("#autoTalkBox").hide();$("#page-wrap").hide();$(".reader-box-container").fadeIn();$(".font-big").click(function(){if($("#readBox").attr("size")<40){var e=parseInt($("#readBox").attr("size"))+2;$("#readBox").attr("size",e);$("#readBox *").css("font-size",e+"px")}});$(".font-samll").click(function(){if($("#readBox").attr("size")>12){var e=parseInt($("#readBox").attr("size"))-2;$("#readBox").attr("size",e);$("#readBox *").css("font-size",e+"px")}})},load:function(c,f,g,a,b){this.init(f,g);if("undefined"!=typeof(b)){var e=b}else{var e="GET"}this.setcontent('<div style="width:150px;height:70px;text-align:center"><div class="load">&nbsp;</div></div>');var d=this;if("undefined"==a){var a={}}jQuery.ajax({url:c,type:e,data:a,cache:false,dataType:"html",success:function(h){d.setcontent(h);d.center();setTimeout(function(){$("#uibox").find('input[type="text"]').eq(0).focus()},100)}})},_viewport:function(){var g=document.documentElement,c=document.body,e=window;var f=e.pageYOffset>0?e.pageYOffset:0;var a=c.scrollTop||g.scrollTop;if(a<0){a=0}return jQuery.extend(/msie/.test(navigator.userAgent.toLowerCase())?{left:c.scrollLeft||g.scrollLeft,top:a}:{left:e.pageXOffset,top:f},!ui.box._u(e.innerWidth)?{width:e.innerWidth,height:e.innerHeight}:(!ui.box._u(g)&&!ui.box._u(g.clientWidth)&&g.clientWidth!=0?{width:g.clientWidth,height:g.clientHeight}:{width:c.clientWidth,height:c.clientHeight}))},_u:function(){for(var a=0;a<arguments.length;a++){if(typeof arguments[a]!="undefined"){return false}}return true},_cssForOverlay:function(){if(ui.box.IE6){return ui.box._viewport()}else{return{width:"100%",height:jQuery(document).height()}}},center:function(d,g){var c=document.body,a=document.documentElement,e=c.scrollTop>0?c.scrollTop:a.scrollTop;var b=ui.box._viewport();var f=[b.left,e];if(g){b.width=b.width-g.width;b.height=b.height-g.height}if(!d||d=="x"){this.centerAt(f[0]+b.width/2,null)}if(!d||d=="y"){this.centerAt(null,f[1]+b.height/2)}return this},moveToX:function(a){if(typeof a=="number"){$("#uibox").css({left:a})}else{this.centerX()}return this},moveToY:function(a){if(typeof a=="number"){if(a<=0){a=0}$("#uibox").css({top:a})}else{this.centerY()}return this},centerAt:function(a,c){var b=this.getSize();if(typeof a=="number"){this.moveToX(a-b[0]/2)}if(typeof c=="number"){this.moveToY(c-b[1]/2)}return this},centerAtX:function(a){return this.centerAt(a,null)},centerAtY:function(a){return this.centerAt(null,a)},getSize:function(){return[$("#uibox").width(),$("#uibox").height()]},getContent:function(){return $("#uibox").find(".boxy-content")},getPosition:function(){var a=$("#uibox");return[a.offsetLeft,a.offsetTop]},getContentSize:function(){var a=this.getContent();return[a.width(),a.height()]},_getBoundsForResize:function(c,a){var b=this.getContentSize();var e=[c-b[0],a-b[1]];var d=this.getPosition();return[Math.max(d[0]-e[0]/2,0),Math.max(d[1]-e[1]/2,0),c,a]}}};
>>>>>>> eb6cd04f6983f21c132e1707fb9170bb59a6043b
