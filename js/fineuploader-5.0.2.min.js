...
!function() {
...
}(), qq.version = "5.0.2", qq.supportedFeatures = function() {
    "use strict";
    function a() {
        var a, b=!0;
        try {
        ...
        _createUploadHandler: function(a, b) {
            var c = this, d = {}, e = {
                ...
                onProgress: function(a, b, e, f) {
                    d[a] ? (d[a].loaded !== e || d[a].total !== f) && (c._onProgress(a, b, e, f), c._options.callbacks.onProgress(a, b, e, f)) : (c._onProgress(a, b, e, f), c._options.callbacks.onProgress(a, b, e, f)), d[a] = {
                        loaded: e,
                        total: f
                    }
                },
    ...
    function j(a, b) {
        ...
        return w.onSend(a), c = k(a, h), d(e) ? (e.onload = n(a), e.onerror = o(a)) : e.onreadystatechange = l(a), m(a), e.open(g, c, !0), w.cors.expected && w.cors.sendCredentials&&!d(e) && (e.withCredentials=!0), p(a), s("Sending " + g + " request for " + a), j ? e.send(j) : t ||!h ? e.send() : e.send(h && w.contentType && w.contentType.toLowerCase().indexOf("application/x-www-form-urlencoded") >= 0 ? qq.obj2url(h, "") : h && w.contentType && w.contentType.toLowerCase().indexOf("application/json") >= 0 ? JSON.stringify(h) : h), e
    }
    function k(a, b) {
    ...
    function b() {
        ...
        if (b = qq.trimStr(b), d = document.createElement("div"), d.appendChild(qq.toElement(b)), P.button && (f = qq(d).getByClass(Q.button)[0], f && qq(f).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (i = qq(d).getByClass(Q.dropProcessing)[0], i && qq(i).remove()), g = qq(d).getByClass(Q.drop)[0], g&&!qq.DragAndDrop && (A("DnD module unavailable.", "info"), qq(g).remove()), g&&!qq.supportedFeatures.fileDrop && qq(g).hasAttribute(M) && qq(g).css({
            display: "none"
        }), h = qq(d).getByClass(Q.thumbnail)[0], G ? h && (O = parseInt(h.getAttribute(K)), O = O > 0 ? O : null, H = qq(h).hasAttribute(L)) : h && qq(h).remove(), G = G && h, B = qq(d).getByClass(Q.editFilenameInput).length > 0, C = qq(d).getByClass(Q.retry).length > 0, c = qq(d).getByClass(Q.list)[0], null == c)
    ...
    function d(a, b) {
        ...
        try {
            ...
            i("Error when attempting to parse form upload response (" + g.message + ")", "error"), d = {
                success: !1
            }
        }
        return d
    ...
    qq.extend(this, {
        uploadChunk: function(b, d, f) {
            ...
            return g = k(b, m), c._registerProgressHandler(b, d, l.size), j = a.paramsStore.get(b), i(b, j, l), f && (j[a.resume.paramNames.resuming]=!0), h = q(j, m, l.blob, b), r(b, m), m.send(h), g
        },
    ...
    function e(c, e, g, h) {
        ...
        if (f(e, k, l, g.orientation), qq.ios()) {
            ...
            for (var r = q.getContext("2d"), s = h ? b(c, i, j) : 1, t = Math.ceil(p * k / i), u = Math.ceil(p * l / j / s), v = 0, w = 0; j > v;) {
                for (var x = 0, y = 0; i > x;)
                    r.clearRect(0, 0, p, p), r.drawImage(c, - x, - v), m.drawImage(q, 0, 0, p, p, y, w, t, u), x += p, y += t;
                v += p, w += u
            }
            m.restore(), q = r = null
        } else 
            m.drawImage(c, 0, 0, k, l);
    ...
    function e(a, b) {
        return !a.checkValidity || a.checkValidity()?!0 : (c("Form did not pass validation checks - will not upload.", "error"), void b())
    }
    function f(a) {
        var c = a.submit;
