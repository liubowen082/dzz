...
define(function(require, exports, module) {
	...
	var moduleList = {
		...
		'data_list' : { // 清单
			...
			'value' : '<div class="data-list js_list"><input type="text" class="q-txt" placeholder="名称" style="width:150px" value="#{value1}"><input type="text" class="q-txt" placeholder="#{option}" style="width:60px"  value="#{value2}" node-name="data-list-num"><span class="vline">#{option1}</span><div class="widget-date"><input type="text" class="q-txt rcalendar_input" onclick="laydate()" readonly="readonly" placeholder=""  value="#{value3}"><i class="icon-clock2"></i></div><span class="icon-plus js_add" node-name="data_list_add"  option="#{option}" option_else="#{option_else}" data_option="#{data_option}"></span></div>',
			'valueOther' : '<div class="data-list js_list"><input type="text" class="q-txt" placeholder="名称" style="width:150px" value="#{value1}"><input type="text" class="q-txt" placeholder="#{option}" style="width:60px" value="#{value2}" node-name="data-list-num"><span class="vline">#{option1}</span><div class="widget-date" model-node="date_widget_load"><input type="text" class="q-txt rcalendar_input" onclick="laydate()" placeholder="" value="#{value3}"><i class="icon-clock2"></i></div><span class="js_add icon-close" node-name="data_list_remove"></span></div>'
		},
		'user' : {
			'name':'人名输入框',
