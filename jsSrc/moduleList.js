...
define(function(require, exports, module) {
	...
	var moduleList = {
		...
		'data_list' : { // 清单
			'name':'清单',
			'tpl' : '<dl id="#{id}" class="ui-draggable" rel="data_list"  data-title="清单" data-data_format="time" data-data_option="金额|元"><dt rel="date_between">#{title||default:清单}</dt><dd><input type="text" class="q-txt" style="width:150px;" placeholder="名称" disabled="" value="#{value1}">&nbsp;&nbsp;<input type="text" class="q-txt" placeholder="0" style="width:60px;" disabled="" >&nbsp;<span class="js_else">#{value2}</span>&nbsp;&nbsp;<input type="text" class="q-txt" placeholder="时间" style="width:150px;" disabled="">&nbsp;&nbsp;<span class="ico-plus"></span><br>总计：<span class="js_else">元</span></dd><dd><a class="icon-close" href="javascript:;"></a></dd>',
